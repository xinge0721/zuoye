...
public class camera { // 类声明，定义交通信号灯相关功能
    ...
    public camera(Context context, ImageView image_show, TextView wifi_ip, TextView camera_ip, TextView show_news) { // 构造函数，初始化UI组件和上下文
     ...
     * 初始化WiFi设置和摄像头搜索
     */
    public void trafficlight_Init(String IPCar) { // 初始化函数，传入摄像头IP
